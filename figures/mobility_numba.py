...
@njit(parallel=True)
def no_wall_mobility_trans_times_force_numba(r_vectors, force, eta, a, L, num_imgs):
  ''' 
...
@njit(parallel=True)
def single_wall_mobility_trans_times_force_numba(r_vectors, force, eta, a, L, num_img):
  ''' 
  Returns the product of the mobility at the blob level to the force 
  on the blobs. Mobility for particles in an unbounded domain, it uses
  the standard RPY tensor.  
...
@njit(parallel=True)
def no_wall_mobility_trans_times_torque_numba(r_vectors, torque, eta, a, L,num_imgs):
  ''' 
...
@njit(parallel=True)
def single_wall_mobility_trans_times_torque_numba(r_vectors, torque, eta, a, L,num_imgs):
  ''' 
  Returns the product of the mobility translation-rotation at the blob level to the torque 
...
@njit(parallel=True)
def no_wall_mobility_rot_times_force_numba(r_vectors, force, eta, a, L, num_img):
  ''' 
  Returns the product of the mobility translation-rotation at the blob level to the torque 
  on the blobs. Mobility for particles in an unbounded domain, it uses
  the standard RPY tensor.  
...
@njit(parallel=True)
def single_wall_mobility_rot_times_force_numba(r_vectors, force, eta, a, L,num_img):
  ''' 
  Returns the product of the mobility translation-rotation at the blob level to the torque 
  on the blobs. Mobility for particles in an unbounded domain, it uses
  the standard RPY tensor.  
...
@njit(parallel=True)
def no_wall_mobility_rot_times_torque_numba(r_vectors, torque, eta, a, L, num_imgs):
  ''' 
  Returns the product of the mobility translation-rotation at the blob level to the torque 
  on the blobs. Mobility for particles in an unbounded domain, it uses
  the standard RPY tensor.  
...
@njit(parallel=True)
def single_wall_mobility_rot_times_torque_numba(r_vectors, torque, eta, a, L,num_imgs):
  ''' 
  Returns the product of the mobility translation-rotation at the blob level to the torque 
  on the blobs. Mobility for particles in an unbounded domain, it uses
  the standard RPY tensor.  
